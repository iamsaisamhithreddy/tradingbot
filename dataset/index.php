        ...
        while (false !== ($entry = readdir($handle))) {
            if ($entry != "." && $entry != "..") {
                ...
                if (is_dir($path)) {
                    ...
                    // listDirectory($path, $rootDir, $baseUrl); // hiding intensionally, remove this comment if needed. 
                    echo "</li>";
                } else {
...
echo "ALL CSV FILES ARE UPDATED FROM May 22, 2026 onwards collected from forexfactory.com</h2>";
