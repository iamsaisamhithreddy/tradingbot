...
// 1. Require your database and config file
require 'db.php'; 

ini_set('display_errors', 1);
error_reporting(E_ALL);

// Ensure the website URL is built from the token inside db.php
$website = "https://api.telegram.org/bot8625071697:AAEEphJliuYa20agGm9HVFK68AH7WqmPWFc";
$witAiToken = 'RWG6LN52R44VEONELKE4C4VV7D67F3PN'; // Your Wit.ai Token
$witVersion = '20240304';
    ...
    if ($fileResponse['ok']) {
        ...
        if ($audioData) {
            ...
            if ($transcribedText !== "Sorry, I couldn't process the audio.") {
                ...
                // Grab the endpoint from db.php (fallback just in case)
                global $AI_ENDPOINT;
                $endpointToUse = isset($AI_ENDPOINT) ? $AI_ENDPOINT : "$WebsiteURL"."/ai_admin_analytics.php";
