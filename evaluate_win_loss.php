...
// ==========================================
// 4. THE EVALUATOR (RETURNS RESULT, TIME, PRICE)
// ==========================================
                ...
                if ($c['close'] < $targetPrice) {
                    if (!$targetBroken) {
                        if ($waveLength < 3) { // 6 candle logic , after 2 candle confirmation , 1 candle price broken, hence 3 candles
                                                // $waveLength < 3 for forex factory , 6 candle strategy for immediate reversal..
                                                // $waveLength < 4 for normal tradingview  6 candle strategy for immediate reversal..
